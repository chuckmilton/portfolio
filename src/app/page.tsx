      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center bg-gray-900 text-white overflow-hidden">
        ...
        <div className="text-center px-6">
          ...
          >
            ...
            <a
              href="/images/Resume_Charles_Milton.pdf"
              target="_blank"
              className="px-6 py-3 bg-teal-600 rounded-lg text-white font-semibold hover:bg-teal-500 transition-transform transform hover:scale-105 shadow-md"
            >
              View Resume
            </a>
          </motion.div>
