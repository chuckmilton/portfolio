...
export default function Projects() {
  const projects = [
    ...
    },
    {
      ...
      description:
        'Engineered a Chrome extension that integrates professor ratings into CSULB’s registration system, reducing query latency by 50% using GraphQL and LRU caching. The tool has 300+ active users.',
